...
function FieldLegend({
  ...
  return (
    <Text
      ...
      className={cn(
        "font-medium text-foreground data-[variant=label]:text-sm data-[variant=legend]:text-base",
        className,
      )}
      {...props}
    />
...
function FieldGroup({ className, ...props }: ViewProps) {
  return (
    <View
      ...
      className={cn(
        "group/field-group @container/field-group gap-5 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-4",
        className,
      )}
      {...props}
    />
